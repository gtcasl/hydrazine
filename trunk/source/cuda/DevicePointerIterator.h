...
#include <common/interface/Iterator.h>
#include <cuda_runtime_api.h>
#include <common/cuda/CudaException.h>
	...
	*/
	...
	class DevicePointerIterator
	{
		public:
			...
			typedef typename common::IteratorTraits< Type >::concept concept;
			typedef typename common::IteratorTraits< Type >::value_type 
				value_type;
			typedef typename common::IteratorTraits< Type >::difference_type 
				difference_type;
			typedef typename common::IteratorTraits< Type >::pointer pointer;

			class Reference;
			typedef typename common::IteratorTraits< Type >::reference 
				base_reference;
